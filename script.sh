...
#devrev profiles authenticate --env dev --org devrev-back --usr i-shams.ansari@devrev.ai
devrev_id="i-venkata.mangichetty@devrev.ai"
echo "Initiating DevRev CLI Authentication for DevRev ID: ${devrev_id}"
devrev profiles authenticate --env dev --org devrev-back --usr ${devrev_id}
if [ $? -eq 0 ]; then
...
# echo $package_creation_response
